...
VALUES (1, 'Beneficiario Test', '12345678');
...
;
INSERT INTO `centros_operacion`
VALUES (7, 'Centro Arequipa'),
(8, 'Centro Cusco'),
(4, 'Centro Este'),
(6, 'Centro Lima'),
(2, 'Centro Norte'),
...
CREATE TABLE `documentos` (
  ...
  CONSTRAINT `documentos_fk_etapa` FOREIGN KEY (`id_etapa`) REFERENCES `actividades_etapa` (`id_etapa`) ON DELETE
  SET NULL,
    CONSTRAINT `documentos_fk_infocon` FOREIGN KEY (`id_informacioncontratista`) REFERENCES `informacioncontratista` (`id`) ON DELETE
  SET NULL,
    CONSTRAINT `documentos_fk_infofin` FOREIGN KEY (`id_informacionfinancista`) REFERENCES `informacionfinancista` (`id`) ON DELETE
  SET NULL,
    CONSTRAINT `documentos_fk_obras` FOREIGN KEY (`id_obra`) REFERENCES `obras` (`id_obra`) ON DELETE
  SET NULL,
    CONSTRAINT `documentos_fk_pago` FOREIGN KEY (`id_pago`) REFERENCES `pagos` (`id_pago`) ON DELETE
  SET NULL,
    CONSTRAINT `documentos_fk_uploaded_by` FOREIGN KEY (`uploaded_by`) REFERENCES `usuarios` (`id_responsable`) ON DELETE
  SET NULL
...
;
INSERT INTO `estados_etapa`
VALUES (1, 'Priorización', 1, '#722AE9'),
...
;
INSERT INTO `estados_obra`
VALUES (1, 'Priorizacin', 1, '#722AE9'),
(2, 'Actos Previos', 2, '#FFA500'),
(3, 'Seleccin', 3, '#FFD700'),
(4, 'Ejecucin', 4, '#2196F3'),
...
;
INSERT INTO `estados_reembolso`
VALUES (2, 'No Reembolsado'),
(1, 'Reembolsado');
...
;
INSERT INTO `obra_centro_operacion`
VALUES (4, 1),
(4, 2),
(4, 3),
(4, 4),
...
CREATE TABLE `obras` (
  ...
  CONSTRAINT `fk_obra_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `usuarios` (`id_responsable`) ON DELETE
  SET NULL,
...
;
INSERT INTO `obras`
VALUES (1, 'Obra 1', 9, 1, '2025-11-25', '2025-11-26', 1, 2, 1),
(
    2,
    'Obra 1',
    9,
...
/*!50003 TRIGGER `obras_auditoria_insert` AFTER INSERT ON `obras` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `obras_auditoria_update` AFTER UPDATE ON `obras` FOR EACH ROW BEGIN
 INSERT INTO `auditoria` (`tabla_afectada`, `id_registro`, `accion`, `usuario`)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `obras_auditoria_delete` AFTER DELETE ON `obras` FOR EACH ROW BEGIN
 INSERT INTO `auditoria` (`tabla_afectada`, `id_registro`, `accion`, `usuario`)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `pagos_before_insert` BEFORE INSERT ON `pagos` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `pagos_auditoria_insert` AFTER INSERT ON `pagos` FOR EACH ROW BEGIN
 INSERT INTO `auditoria` (`tabla_afectada`, `id_registro`, `accion`, `usuario`)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `pagos_before_update` BEFORE UPDATE ON `pagos` FOR EACH ROW BEGIN
 IF NEW.id_tipo_gasto = (SELECT id FROM tipos_gasto WHERE nombre = 'Administrativo') THEN
 SET NEW.id_estado_reembolso = (SELECT id FROM estados_reembolso WHERE nombre = 'No Reembolsado');
 END IF;
 END */
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `pagos_auditoria_update` AFTER UPDATE ON `pagos` FOR EACH ROW BEGIN
 INSERT INTO `auditoria` (`tabla_afectada`, `id_registro`, `accion`, `usuario`)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `pagos_auditoria_delete` AFTER DELETE ON `pagos` FOR EACH ROW BEGIN
 INSERT INTO `auditoria` (`tabla_afectada`, `id_registro`, `accion`, `usuario`)
...
(
    10,
    'IOARR',
    'Inversión de Reposición y Rehabilitación'
  ),
(
    11,
    'IOARR de emergencia',
    'IOARR ejecutadas en situaciones de emergencia'
  ),
(
    12,
    'Operación',
